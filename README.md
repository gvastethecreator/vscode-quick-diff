...
**Compare a selection, file, or clipboard in one command**
...
1) Clone [gvastethecreator/vscode-quick-diff](https://github.com/gvastethecreator/vscode-quick-diff), then run `pnpm install`.
2) Press F5 (`Run Extension`).
3) Select text, then run **Compare Selection with Clipboard**.
