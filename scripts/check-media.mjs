...
await verifyAlphaBounds(iconSource, "Imagegen icon source");
...
console.log("Media checks passed: deterministic icon and tightly cropped native-alpha runtime preview.");
