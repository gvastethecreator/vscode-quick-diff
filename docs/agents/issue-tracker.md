...
- Project number: `28`
- Project title: `Quick Diff`
- Project URL: https://github.com/users/gvastethecreator/projects/28
- Local root: `.scratch/vscode-quick-diff/`
...
- Spec: `.scratch/vscode-quick-diff/spec.md` (`PRD.md` remains compatible).
- Ticket mirrors: `.scratch/vscode-quick-diff/issues/<NN>-<slug>.md`. Never under `docs/`.
- Rejected requests: `.scratch/vscode-quick-diff/out-of-scope/<concept>.md`.
...
GitHub project: https://github.com/users/gvastethecreator/projects/28
...
5. Add the Issue to Project `28` under `gvastethecreator`.
...
```powershell
gh issue view <number> -R gvastethecreator/vscode-quick-diff --json number,title,state,body,labels,assignees,comments,updatedAt,url
gh project view 28 --owner gvastethecreator --format json
gh project field-list 28 --owner gvastethecreator --format json
gh project item-list 28 --owner gvastethecreator --limit 200 --format json --field Status
gh project item-add 28 --owner gvastethecreator --url <issue-url>
gh project item-edit 28 --owner gvastethecreator --url <issue-url> --field Status --value Todo
gh issue create -R gvastethecreator/vscode-quick-diff --title <title> --body-file <path> --parent <parent-number> --blocked-by <number,number>
gh issue edit <issue-number> -R gvastethecreator/vscode-quick-diff --parent <parent-number> --add-blocked-by <number>
```
