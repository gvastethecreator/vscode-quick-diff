...
VS Code extension (`gvastethecreator.quick-diff`). pnpm. TypeScript in `src/`. esbuild writes `dist/extension.js`.
...
- Do not write tickets under `docs/`. Local tickets: `.scratch/vscode-quick-diff/issues/`.
